 ...
 *
 * @description :: Server-side logic for managing disciplina
...
module.exports = {
    ...
    index: function(req, res) {
        return res.view('disciplina/index', {
            footer: [
                '/js/modules/disciplina/index.js'
            ]
        });
    },

    /**
     * `DisciplinaController.query()`
    ...
    query: function(req, res) {
        ...
        */
        ...
        if (search && search.value) {
            ...
            queryCond.skip = skip
            query = Disciplina.find(queryCond)
        ...
        Disciplina.count(cond).exec(function(error, count) {
    ...
    update: function(req, res) {
        ...
        if (pkid && !isNaN(pkid)) {
            ...
            Disciplina.create(model).exec(function(err, newmodel) {
                if (!err) {
                    rt.success = true
                    rt.msg = ''
                } else {
